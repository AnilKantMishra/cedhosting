...
<html>
<head>
<title>Planet Hosting a Hosting Category Flat Bootstrap Responsive Website Template | Services :: w3layouts</title>
                        ...
                        <div class="linux-prices" id="myTab">
                            <div class="col-md-3 linux-price">
                                    ...
                                    <div class="linux-bottom">
                                        <h5>₹100 <span class="month">per Month</span></h5>
                                        <h5>₹800 <span class="month">per Annum</span></h5>
                                        <h6>Single Domain</h6>
                                        <ul>
                                        <li><strong>1GB </strong> Web Space</li>
                                        <li><strong>2.5GB </strong>Bandwidth</li>
                                    ...
                                    <div class="linux-bottom">
                                        <h5>₹300 <span class="month">per Month</span></h5>
                                        <h5>₹1800 <span class="month">per Annum</span></h5>
                                        <h6>Single Domain</h6>
                                        <ul>
                                        <li><strong>3.5GB </strong> Web Space</li>
                                        <li><strong>3.5GB </strong>Bandwidth</li>
                                        <li><strong>2 </strong> Mailbox</li>
                                        <li><strong>3 </strong> Free Domain</li>
