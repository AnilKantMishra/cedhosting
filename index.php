		...
		<div class="container">
			<div class="banner-grids">
				<div class="col-md-6 banner-grid">
					<img src="images/laptop.jpg" display: block; max-width: 100%; height: auto; class="img-responsive" style="margin-bottom: 40px; margin-right:20px"
						alt=""  />
				</div>
				<div class="col-md-6 banner-grid">
					...
					<ul id="da-thumbs" class="da-thumbs">
						<li>
							<a href="images/t1.jpg" class="b-link-stripe b-animate-go thick box">
								...
								<div>
									<h5>team</h5>
									<span>non suscipit leo fringilla non suscipit leo fringilla molestie That’s how we
										set ourselves apart</span>
								</div>
							</a>
						</li>
						<li>
